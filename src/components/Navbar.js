    ...
    return (
        <div className='flex justify-between items-center w-full h-20 shadow-lg pl-10 pr-14 shadow-gray-100 sticky top-0 bg-white' >
            ...
            <div className='flex gap-5'>
                ...
                {
                    firebase.user ? <span className='text-xl cursor-pointer' onClick={() => firebase.signOut()}><i className='bx bxs-log-out bx-sm align-middle' ></i> Sign Out</span> : <Link to='/login'> <span className='text-xl'><i className='bx bxs-log-in bx-sm align-middle' ></i> Sign In</span></Link>
                }
